        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="col-xl-6 col-lg-8">
                    <h1>Login yuk!<span>.</span></h1>
                </div>
            </div>
            <div class="row justify-content-center mt-4" data-aos="fade-up" data-aos-delay="150">

                <form action="login.php" method="post" class="col-xl-3 col-lg-6">
                    ...
                    <div class="mt-3"><button type="submit" class="btn btn-warning">Masuk</button></div>
                    <p class="mt-4">Belum punya akun? <a href="register.php">Daftar</a> </p>
                </form>
            </div>
